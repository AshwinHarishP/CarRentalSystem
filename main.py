            ...
            while True:
                ...
                if choice == "1":
                    ...
                    try:
                        ...
                        try:
                            self.repo.findCustomerById(cust_id)
                            print(f"Customer with ID {cust_id} already exists.")
                            ...
                            res = self.repo.addCustomer(cust)
                            print("Customer added successfully." if res else "Error in adding customer.")
